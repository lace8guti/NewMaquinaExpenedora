...
// Controlador de targetes associades

public class SeptdecaryController {
    ...
    @FXML
    Button buttonRegistraTargeta;
    
    @FXML
    Button buttonIntrodueixTargeta;
    
    @FXML
    Button buttonIntrodueixTargetaX;
    
    @FXML
    Button buttonRetiraTargeta;
    
    @FXML
    Button buttonRetiraTargetaX;
