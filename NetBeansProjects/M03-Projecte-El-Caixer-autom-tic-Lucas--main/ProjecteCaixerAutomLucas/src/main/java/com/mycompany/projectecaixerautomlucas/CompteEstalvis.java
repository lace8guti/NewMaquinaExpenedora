...
public class CompteEstalvis {
    ...
    public CompteEstalvis(String numero, double saldo) {
    ...
    public CompteEstalvis(double saldo) {
        comptador=comptador+1;
    ...
    public String toString() {
        return "CompteEstalvis{" + "numero=" + numero + ", saldo=" + saldo + ", bloquejat=" + bloquejat + ", client=" + client + '}';
