...
// Controlador de transferencia de dinero en cuentas corrientes

public class SexdecaryController {
    
    @FXML
    ListView listviewCompteDonador;
    
    @FXML
    ListView listviewCompteRebedor;
    
    @FXML
    TextField textfieldDinersCompte;
    
    @FXML
    TextField textfieldDinersRetirar;
    
    @FXML
    Button buttonTargeta;
    
    @FXML
    Button buttonTargetaX;
    ...
    @FXML
    private void Enrere() throws IOException {
